...
var getFile = function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, readFile(path_1.default.join(__dirname, 'email.html'), "UTF-8")];
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            getFile().then(function (data) {
                ...
                mailOptions.to = kdo;
                transporter.sendMail(mailOptions, function (data) {
                    console.log(data);
                });
            });
            return [2 /*return*/];
